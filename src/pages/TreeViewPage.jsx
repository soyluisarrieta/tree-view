  ...
  return (
    <main className='flex justify-center gap-x-7'>
        ...
        <TreeView title='Soy el titulo principal' className='w-96'>
          ...
          <TreeBranch title='Item 2'>
            ...
            <TreeBranch title='Item 2.5'>
              ...
              <TreeBranch title='Item 2.5.4'>
                <TreeItem>Item 2.5.4.1</TreeItem>
                <TreeItem>Item 2.5.4.2</TreeItem>
                <TreeItem>Item 2.5.4.3</TreeItem>
              </TreeBranch>
            </TreeBranch>
          </TreeBranch>
      ...
      <div className='w-full max-w-3xl'>
        ...
        <img className='w-' src='image_processing20211118-15492-16gegj.webp' alt='Reference' />
      </div>
    </main>
  )
}
